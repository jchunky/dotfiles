...
alias pm_gql='cd packmanager; rake private_graphql_api:generate_schema; rake production_scheduling_public_graphql_api:generate_schema; cd packmanager/client_react; yarn codegen; cd packmanager'
