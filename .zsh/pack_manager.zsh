...
PM_DEV_CAPYBARA_MAX_WAIT_TIME_IN_SECONDS=600
PM_DEV_ENABLE_BOOTSNAP=true
PM_DEV_EXCEPTION_NOTIFIER_FAIL_FAST=true
# PM_DEV_EXECUTE_BACKGROUND_TASKS_IMMEDIATELY=true
PM_DEV_PERFORM_BACKGROUND_TASKS_INLINE=true
PM_DEV_POLLING_INTERVAL_IN_SECONDS=600
PM_DEV_REQUEST_TIMEOUT_IN_MINUTES=10
PM_DEV_SHOW_LOCAL_DEVELOPMENT_INFO=true
# PM_DEV_SILENCE_CONSOLE_HINTS=true
PM_DEV_SILENCE_RESQUE_LOGGING=true
PM_SENTRY_ACTIVE=false
SKIP_SCHEDULE_ALL_TASKS=true
...
alias pm_gql='cd packmanager; rake private_graphql_api:generate_schema; cd packmanager/client_react; yarn codegen; cd packmanager'
...
alias pm_update='bundle; pmu; rake db:test:prepare'
