...
alias pm_gql='cd packmanager/client_react/desktop; yarn download:schema; yarn codegen; cd packmanager/client_react/mobile; yarn download:schema; yarn codegen; '
