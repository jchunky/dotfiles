...
# https://github.com/nulogy/packManager/blob/main/development.env.sample - 2025-08-18
...
alias pm_seed_candy_pack_with_picking='rake nulogy:tdc:candy_pack:schedule:fs_variety_mix; rails runner TestDataCatalog::CatalogExtensions::CandyPack::PickListReservations.configure'
