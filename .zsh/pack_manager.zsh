...
export PM_DEV_OPEN_DEVELOPER_TOOLS_IN_CHROME=1
...
# export PM_DEV_SILENCE_CONSOLE_HINTS=true
export PM_DEV_SILENCE_RESQUE_LOGGING=true
export PM_SENTRY_ACTIVE=false
export SKIP_SCHEDULE_ALL_TASKS=true
export UNICORN_WORKER_PROCESSES=1
...
alias fra_minimal='bundle exec overmind start -f Procfile.minimal'
...
alias pm_frontend_mobile_watch='yarn start'
alias pm_gql='cd packmanager; rake private_graphql_api:generate_schema; rake production_scheduling_public_graphql_api:generate_schema; rake tng_graphql_api:generate_schema; cd packmanager/client_react; yarn codegen; cd packmanager'
...
alias pm_seed_candy_pack='rake nulogy:tdc:candy_pack:schedule:fs_variety_mix; rails runner TestDataCatalog::CatalogExtensions::CandyPack::PickListReservations.configure'
alias pm_seed_choco_pack='rake nulogy:tdc:choco_pack:schedule:fs_variety_mix'
alias pm_seed_consumer_pack_1='rake nulogy:tdc:consumer_pack:schedule:influencer_kits'
alias pm_seed_consumer_pack_2='rake nulogy:tdc:consumer_pack:consumer_ship_order_csv'
