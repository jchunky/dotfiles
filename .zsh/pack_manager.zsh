...
alias pm_kill='kill_processes_listening_on 3000; kill_processes_listening_on 3011; kill_processes_listening_on 5500; kill_processes_listening_on 5555; pkill -9 -i -f nginx; pkill -9 -i -f unicorn; pkill -9 -i -f node;'
alias pm_merge='thor nugit:integrate'
alias pm_migration_update='rake ndp:update'
